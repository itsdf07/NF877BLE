...
import static com.itsdf07.nf877ble.blelib.server.core.OKBLEServerOperation.BLEServerOperationListener.Operation_FAILED_Invalid_Characteristic_UUID;
import static com.itsdf07.nf877ble.blelib.server.core.OKBLEServerOperation.BLEServerOperationListener.Operation_FAILED_Invalid_Service_UUID;
...
public class OKBLEServerDeviceImp implements  OKBLEServerDevice{
    private static final String TAG = "OKBLEServerDeviceImp";
